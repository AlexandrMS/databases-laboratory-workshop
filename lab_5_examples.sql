...
/* Пример 9: Вывести количество стран по первым буквам в названии. 
Результат отсортировать в алфавитном порядке: */
SELECT 
...
/* Пример 15: : Вывести список континентов, у которых средняя плотность среди стран с
площадью более 1 млн. кв. км больше, чем 30 чел. на кв. км. Результат отсортировать по плотности по убыванию: */
SELECT 
	Континент,
