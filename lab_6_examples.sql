...
/* Пример 6: Вывести список студентов, сдавших хотя бы один экзамен. По правилам
соединения, студенты, не сдававшие экзамены, в выборке представлены не будут: */
SELECT
	С.Фамилия
FROM
	Студент С
...
/* Пример 7: Вывести из таблиц «Студент» и «Экзамен» учетные номера и фамилии студентов, 
а также количество сданных экзаменов и средний балл для каждого студента: */
SELECT
	С.Фамилия,
